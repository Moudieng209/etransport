...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM utilisateurs where role='client' ORDER BY id ASC");
    $stmt->execute();
...
<h1 style="display:flexbox; margin-top:0px; margin-left:450px; margin-right:420px;">Liste des clients</h1><br><br>
