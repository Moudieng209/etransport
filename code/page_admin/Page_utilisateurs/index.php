...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM utilisateurs ORDER BY id ASC");
    $stmt->execute();
...
<a href="ajout.php"  style="margin-left: 470px; padding-top: 20px;"><i class='bx bxs-plus-circle'></i> Ajouter un utilisateur</a>
<h1 style="display:flexbox; margin-top:0px; margin-left:450px; margin-right:420px;">Liste des Utilisateurs</h1><br><br>
